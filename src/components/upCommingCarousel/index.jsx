            ...
            <Row>
              <Col xs={12} lg={7}>
                <div className="ltn__upcoming-project-img">
                  <Image src="/img/product-3/3.jpg" alt="#" width={750} height={500}/>
                </div>
              </Col>
        ...
        <Col xs={12}>
          <div className="ltn__upcoming-project-item">
            <Row>
              <Col xs={12} lg={7}>
                <div className="ltn__upcoming-project-img">
                  <Image src="/img/product-3/2.jpg" alt="#" width={500} height={500}/>
                </div>
              </Col>
              <Col xs={12} lg={5} className="section-bg-1">
                <div className="ltn__upcoming-project-info ltn__menu-widget">
        ...
        <Col xs={12}>
          <div className="ltn__upcoming-project-item">
            <Row>
              <Col xs={12} lg={7}>
                <div className="ltn__upcoming-project-img">
                  <Image src="/img/product-3/7.jpg" alt="#" width={500} height={500}/>
                </div>
              </Col>
              <Col xs={12} lg={5} className="section-bg-1">
                <div className="ltn__upcoming-project-info ltn__menu-widget">
