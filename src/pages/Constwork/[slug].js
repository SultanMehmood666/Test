                ...
                {product[0].carousel.map((single, key) => {
                  return (
                    <div className="ltn__img-slide-item-4" key={key}>
                      <Link href={`${single.img[0].path}`}>
                        <Image
                          src={`${single.img[0].path}`}
                          alt={`${single.title}`}
                          width={1200}
                          height={500}
                        />
              ...
              <Row>
                <Col xs={12} lg={8}>
                  <div className="ltn__shop-details-inner ltn__page-details-inner mb-60">
                            ...
                            <div className="ltn__apartments-tab-content-inner">
                              <div className="row">
                                <div className="col-lg-7">
                                  ...
                                  <Image src={`${FirstFloor[0].image[0].path}`} alt="#" width={500} height={300} />
                                  </div>
                                </div>
                          ...
                          <Tab.Pane eventKey="second">
                            <div className="ltn__product-tab-content-inner">
                              <div className="row">
                                <div className="col-lg-7">
                                  <div className="apartments-plan-img">
                                  <Image src={`${SecondFloor[0].image[0].path}`} alt="#" width={500} height={300} />
                                  </div>
                                </div>
                                <div className="col-lg-5">
                                  <div className="apartments-plan-info">
                    ...
                    <ConstRelatedProp currentPageId={products[0]._id}/>
                  </div>
                </Col>
  ...
  export async function getServerSideProps(context) {
    ...
    try {
      ...
      const response = await fetch(`${baseUrl}/api/Constructions/SpecificConstruction?id=${id}`,{
        method: 'POST',
        mode: 'no-cors'
      });
