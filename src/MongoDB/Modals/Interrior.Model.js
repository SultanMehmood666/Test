...
async function createInterriorModel(formData, files) {
    try {
        const newInterrior = [
            {
        ...
        const createdInterrior = await Interrior.create(newInterrior);
        console.log('Created construction:', createdInterrior);
    } catch (error) {
        console.error("Error:", error);
    }
}

export default createInterriorModel;