              ...
              <Col className="col-lg-8 col-md-12">
                <div className="ltn__blog-details-wrap">
                  <div className="ltn__page-details-inner ltn__blog-details-inner">
                    ...
                    <div className="ltn__blog-meta">
                      <ul>
                        <li className="ltn__blog-author">
                          <Link href="#">
                            <Image src={`/img/blog/${blog.author.img}`} alt="#" width={500} height={500}/>
                            By: {blog.author.name}
                          </Link>
                        </li>
                    ...
                    <Image src={`/img/blog/${blog.thumbImg}`} alt="Image" width={500} height={500}/>
                    ...
                    <div className="ltn__comment-inner">
                      <ul>
                        <li>
                          <div className="ltn__comment-item clearfix">
                            <div className="ltn__commenter-img">
                              <Image src="/img/testimonial/1.jpg" alt="Image" width={500} height={500}/>
                            </div>
                        ...
                        <li>
                          <div className="ltn__comment-item clearfix">
                            <div className="ltn__commenter-img">
                              <Image src="/img/testimonial/4.jpg" alt="Image" width={500} height={500}/>
                            </div>
                            <div className="ltn__commenter-comment">
                              <h6>
                                <Link href="#">Adam Smit</Link>
