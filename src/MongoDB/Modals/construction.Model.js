...
async function ConstructionModel(formData, files) {
    try {
        ...
        const createdConstruction = await Construction.create(newConstruction);
        console.log('Created construction:', createdConstruction);
    } catch (error) {
