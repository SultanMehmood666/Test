...
import RelatedProduct from "@/components/product/constrelatedproduct";
...
// map items
  const Galleryimage1 = product.map((products)=>{return products.gallery.img1}); 
  const Galleryimage2 = product.map((products)=>{return products.gallery.img2});
  const Galleryimage3 = product.map((products)=>{return products.gallery.img3});
              ...
              <Col xs={12} lg={8}>
                <div className="ltn__shop-details-inner ltn__page-details-inner mb-60">
                  <div className="ltn__blog-meta">
                    <ul>
                      ...
                      <li className="ltn__blog-date">
                        ...
                        {product.map((products)=>{return products.date})}
                      </li>
                      <li>
                        <a href="#">
                          <i className="far fa-comments"></i>
                          {product.map((products)=>{return products.comments})}
                          Comments
                        </a>
                      </li>
                    </ul>
                  ...
                  <label>
                    ...
                    {product.map((products)=>{return products.locantion})}
                  </label>
                  ...
                  <p>{product.map((products)=>{return products.description.shortDescription})}</p>
                  ...
                  <div className="property-detail-info-list section-bg-1 clearfix mb-60">
                    <ul>
                      <li>
                        ...
                        <span>{product.map((products)=>{return products.propertyDetails.propertyId})}</span>
                      </li>
                      <li>
                      ...
                      <li>
                        <label>Rooms:</label>{" "}
                        <span>{product.map((products)=>{return products.propertyDetails.rooms})}</span>
                      </li>
                      <li>
                        <label>Baths:</label>{" "}
                        <span>{product.map((products)=>{return products.propertyDetails.baths})}</span>
                      </li>
                      <li>
                        <label>Year built:</label>{" "}
                        <span>{product.map((products)=>{return products.propertyDetails.createdYear})}</span>
                      </li>
                    </ul>
                    <ul>
                      <li>
                      ...
                      <li>
                        <label>Beds:</label>{" "}
                        <span>{product.map((products)=>{return products.propertyDetails.bedrooms})}</span>
                      </li>
                      <li>
                        <label>Price:</label> <span>{product.map((products)=>{return products.price})}</span>
                      </li>
                      <li>
                    ...
                    <ul>
                      ...
                      <li>
                        <div className="property-detail-feature-list-item">
                          ...
                          <div>
                            <h6>Garage</h6>
                            <small>{product.map((products)=>{return products.factsAndFeatures.garage})}</small>
                          </div>
                        </div>
                      </li>
                      <li>
                      ...
                      <li>
                        <div className="property-detail-feature-list-item">
                          ...
                          <div>
                            <h6>Gym Area</h6>
                            <small>{product.map((products)=>{return products.factsAndFeatures.gymArea})}</small>
                          </div>
                        </div>
                      </li>
                      <li>
                      ...
                      <div className="ltn__comment-inner">
                        <ul>
                          <li>
                            <div className="ltn__comment-item clearfix">
                              <div className="ltn__commenter-img">
                                <Image href="/img/testimonial/1.jpg" alt="Image" />
                              </div>
                          ...
                          <li>
                            <div className="ltn__comment-item clearfix">
                              <div className="ltn__commenter-img">
                                <Image href="/img/testimonial/3.jpg" alt="Image" />
                              </div>
                              <div className="ltn__commenter-comment">
                                <h6>
                                  <a href="#">Adam Smit</a>
                          ...
                          <li>
                            <div className="ltn__comment-item clearfix">
                              <div className="ltn__commenter-img">
                                <Image href="/img/testimonial/2.jpg" alt="Image" />
                              </div>
                              <div className="ltn__commenter-comment">
                                <h6>
                                  <a href="#">Adam Smit</a>
                ...
                <aside className="sidebar ltn__shop-sidebar ltn__right-sidebar---">
                  ...
                  <div className="widget ltn__author-widget">
                    <div className="ltn__author-widget-inner text-center">
                      <Image
                        href={`/img/team/${AgentImg}`}
                        alt={`${AgentFullName}`}
                      />
                      <h5>{AgentFullName}</h5>
                      <small>{AgentDest}</small>
                      <div className="product-ratting">
                        <ul>
                          <li>
                            <a href="#">
                        ...
                        return (
                          ...
                          >
                            <div className="product-img">
                              <Link href={`/shop/${slug}`}>
                                <Image
                                  href={`/img/product-3/${product.productImg}`}
                                  alt={slug}
                                />
                              </Link>
                              <div className="real-estate-agent">
                                <div className="agent-img">
                                  <Link href="#">
                                    <Image href={`/img/blog/author.jpg`} alt="#" />
                                  </Link>
                                </div>
                              </div>
                            </div>
...
export async function getServerSideProps(context) {
  ...
  try {
    ...
    const response = await fetch(`https://micasa-server-test.vercel.app/SpecificInterrior?id=${id}`,{
      mode: 'no-cors'
    });
